#ifndef HEADER_LinuxService
#define HEADER_LinuxService
/*
htop - LinuxService.h
...
extern const ServiceClass LinuxService_class;
...
bool Service_isThread(const Service* this);
